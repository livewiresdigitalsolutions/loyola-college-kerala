...
// ── Campus features — each links to the correct existing page ─────────────────
    ...
    <section className="w-full bg-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Link
            href="/campus-life"
            className="lg:col-span-2 relative h-[400px] lg:h-[500px] rounded-2xl overflow-hidden shadow-xl group block"
          >
            <Image
