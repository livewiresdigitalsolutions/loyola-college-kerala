    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          {formData.src && <img src={formData.src} alt="Preview" className="w-16 h-12 rounded object-cover border" />}
        </div>
        <input type="text" placeholder="Or paste image URL" value={formData.src} onChange={(e) => setFormData({ ...formData, src: e.target.value })} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#342D87] focus:border-transparent outline-none w-full text-sm" />
      </div>
      <input type="text" placeholder="Alt text / Description" value={formData.alt} onChange={(e) => setFormData({ ...formData, alt: e.target.value })} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#342D87] focus:border-transparent outline-none" />
