        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm flex-wrap">
              ...
              <span className="text-[#F0B129] font-medium">Research</span>
            </nav>
            ...
            <p className="text-white/80 text-base md:text-lg max-w-xl leading-relaxed">
              Fostering scientific temper, research culture, and lifelong learning
              through multidisciplinary collaboration and engaged scholarship.
            </p>
          </div>
        </div>
      </div>
