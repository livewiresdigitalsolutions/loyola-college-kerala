        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm flex-wrap">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#F0B129] font-medium">News &amp; Upcoming Events</span>
            </nav>
            ...
            <p className="text-white/80 text-base md:text-lg max-w-xl leading-relaxed">
              Stay informed with the latest happenings, announcements, and upcoming
              events at Loyola College Kerala.
            </p>
          </div>
        </div>
      </div>
