        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm flex-wrap">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#F0B129] font-medium">Event Reports</span>
            </nav>
            ...
            <p className="text-white/80 text-base md:text-lg max-w-xl leading-relaxed">
              A retrospective look at the seminars, cultural fests, and monumental achievements
              that shape the vibrant, academic community at Loyola College.
            </p>
          </div>
        </div>
      </div>
