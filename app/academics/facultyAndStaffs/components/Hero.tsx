          ...
          <div className="max-w-7xl mx-auto px-6 w-full">
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
                Dedicated
                <br />
                <span className="text-white/90">Faculty & Staffs</span>
              </h1>

              {/* SUBHEADING */}
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed font-light">
                Meet the guiding minds behind our academic excellence. Our
                distinguished faculty and dedicated staff are committed to
                nurturing talent and fostering holistic growth.
              </p>
