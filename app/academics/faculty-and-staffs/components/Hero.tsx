        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm flex-wrap">
              ...
              <span>Academics</span>
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#F0B129] font-medium">Faculty & Staffs</span>
            </nav>
            ...
            <p className="text-lg md:text-xl text-white/90 mt-4 max-w-2xl">
              Meet the guiding minds behind our academic excellence. Our distinguished faculty and dedicated staff are committed to nurturing talent and fostering holistic growth.
            </p>
          </div>
        </div>
      </div>
