      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl">
            Explore our comprehensive range of academic departments, each committed to excellence in teaching, research, and student development.
          </p>
        </div>

        {/* DEPARTMENTS GRID - Editorial Style */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
          {departments.map((dept) => (
            ...
            >
              {/* IMAGE CONTAINER - Clean rounded corners, no overlay */}
              <div className="relative aspect-[4/3] overflow-hidden rounded-lg mb-5 bg-gray-200">
                <Image
                  src={dept.image}
                  alt={dept.name}
                  fill
              ...
              <div className="flex flex-col flex-grow">
                {/* Accent line */}
                <div className="w-8 h-0.5 bg-emerald-700 mb-4"></div>
                
                {/* PROGRAMME NAME */}
                <h3 className="text-lg font-semibold text-gray-900 mb-3 leading-snug group-hover:text-emerald-700 transition-colors duration-300">
                  {dept.name}
                </h3>
                ...
                <Link
                  href={`/academics/departments/${dept.slug}`}
                  className="inline-flex items-center text-sm font-medium text-emerald-700 hover:text-emerald-800 transition-colors duration-200 group/link"
                >
                  <span>Learn more</span>
