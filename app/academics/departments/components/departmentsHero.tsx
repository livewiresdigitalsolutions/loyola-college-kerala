        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm flex-wrap">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#F0B129] font-medium">Departments</span>
            </nav>
            ...
            <p className="text-lg md:text-xl text-white/90 mt-4 max-w-2xl">
              Discover world-class programs across diverse disciplines, each dedicated to fostering innovation, critical thinking, and academic excellence.
            </p>
          </div>
        </div>
      </div>
