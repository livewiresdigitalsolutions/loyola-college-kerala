...
//       <div>
//         <h3 className="text-lg font-bold text-black mb-4 pb-2 border-b border-blue-200">
//           12th Standard Details (If Not Available Enter 11th Standard Details)
//         </h3>
//         <div className="grid md:grid-cols-2 gap-4 mt-4">
//           <div>
//             <label className="block text-sm font-semibold text-black mb-2">
...
export default function AcademicRecordsTab({
  ...
  const [showTenthOtherBoard, setShowTenthOtherBoard] = useState(false);
  const [showTwelfthOtherBoard, setShowTwelfthOtherBoard] = useState(false);
  ...
  const handleBoardChange = (e: React.ChangeEvent<HTMLSelectElement>, level: 'tenth' | 'twelfth') => {
    const value = e.target.value;
    
    if (level === 'tenth') {
      setShowTenthOtherBoard(value === 'Others');
      if (value !== 'Others') {
        handleChange(e);
      }
    } else {
      setShowTwelfthOtherBoard(value === 'Others');
      if (value !== 'Others') {
        handleChange(e);
      }
    }
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-4">
          ...
          <div>
            ...
            <select
              name="tenth_board"
              value={showTenthOtherBoard ? 'Others' : form.tenth_board || ""}
              onChange={(e) => handleBoardChange(e, 'tenth')}
              disabled={isFormLocked}
              required
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-4">
          ...
          <div>
            ...
            <select
              name="twelfth_board"
              value={showTwelfthOtherBoard ? 'Others' : form.twelfth_board || ""}
              onChange={(e) => handleBoardChange(e, 'twelfth')}
              disabled={isFormLocked}
              required
              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black disabled:bg-gray-100 disabled:cursor-not-allowed"
            >
