...
//   const [examCenters, setExamCenters] = useState<ExamCenter[]>([]); // Added
...
//   // Dynamic tabs based on program level
...
//     // Program level 1 (UG): only 10th & 12th
//     // Program level 2 (PG): 10th, 12th, UG
//     // Program level 3 (PhD): 10th, 12th, UG, PG
...
//         {/* Form Section with Left Sidebar */}
...
//                 {/* Tab 0: Program & Personal Information */}
//                 {activeTab === 0 && (
...
//                             required
//                             className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black"
//                           >
...
//                             onChange={handleChange}
//                             disabled={!form.program_level_id}
//                             required
//                             className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black disabled:bg-gray-100"
//                           >
...
//                             onChange={handleChange}
//                             required
//                             className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black placeholder-gray-400"
//                           />
//                         </div>
...
//                 {/* Tab 1: Contact & Parent Information*/}
//                 {activeTab === 1 && (
//                   <div className="space-y-8 animate-fadeIn">
//                     <div>
//                       <h3 className="text-lg font-bold text-black mb-4 pb-2 border-b border-blue-200">
...
//                             required
//                             rows={2}
//                             className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black placeholder-gray-400 resize-none"
//                           />
//                         </div>
...
//                             placeholder="e.g., English, Math, Science, Social Studies"
//                             onChange={handleChange}
//                             className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black placeholder-gray-400"
//                           />
//                         </div>
...
//                             placeholder="e.g., Physics, Chemistry, Math, English"
//                             onChange={handleChange}
//                             className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none bg-white text-black placeholder-gray-400"
//                           />
//                         </div>
...
//                     {/* UG Details - Show for PG (level 2) and PhD (level 3) */}
...
//                     {/* PG Details - Show only for PhD (level 3) */}
//                     {form.program_level_id === "3" && (
//                       <div>
//                         <h3 className="text-lg font-bold text-black mb-4 pb-2 border-b border-blue-200">
