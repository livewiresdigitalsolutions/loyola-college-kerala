...
//   // Load existing form data - FIXED VERSION
// const loadFormData = async () => {
//   if (!userEmail) return;
...
//         hasBasicInfo: !!data.basicInfo,
//         hasPersonalInfo: !!data.personalInfo,
//         hasAcademicMarks: !!data.academicMarks,
//       });
...
//       // Load academic marks - FIXED to properly populate 12th subjects
//       if (data.academicMarks && Array.isArray(data.academicMarks)) {
//         console.log("Loading academic marks:", data.academicMarks);
        
//         data.academicMarks.forEach((mark: any) => {
//           // Load 12th standard subjects
//           if (mark.qualification_level === "12th") {
//             if (mark.subjects && Array.isArray(mark.subjects) && mark.subjects.length > 0) {
//               console.log("Loading 12th subjects:", mark.subjects);
//               setTwelfthSubjects(mark.subjects);
//             } else {
//               console.log("No 12th subjects found, using default");
//               setTwelfthSubjects([
//                 {
//                   subject_name: "",
//                   marks_obtained: undefined,
...
//           // Also populate the flat form fields from academic marks
...
//           if (mark.qualification_level === "12th") {
//             sanitizedData.twelfth_register_number = mark.register_number || "";
...
//         // Update form with academic data
//         setForm(sanitizedData);
//       }

//       // Check completed tabs AFTER setting form data
//       checkCompletedTabs(sanitizedData);
...
// // Restore tab FIRST when data loads
// useEffect(() => {
...
//       console.log("Restoring saved tab:", tabIndex);
//       setActiveTab(tabIndex);
//     }
    
//     // Mark that we've restored the tab
//     setHasRestoredTab(true);
//   }
// }, [dataLoaded, userEmail, hasRestoredTab]);

// // Save tab changes ONLY after restoration is complete
// useEffect(() => {
//   // Only save if:
//   // 1. Data has been loaded
//   // 2. We've already restored the saved tab (prevents saving 0 on mount)
//   if (dataLoaded && userEmail && hasRestoredTab) {
...
//     if (activeTab < tabs.length - 1) {
//       const newTab = activeTab + 1;
//       console.log("Moving to tab:", newTab); // Add this log
//       setActiveTab(newTab);
      
//       // Manually save the new tab (redundant but ensures it's saved)
//       localStorage.setItem(
//         `admission_active_tab_${userEmail}`,
//         newTab.toString()
//       );
