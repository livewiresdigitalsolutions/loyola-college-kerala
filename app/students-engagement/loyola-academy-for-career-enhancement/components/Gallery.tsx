...
const galleryImages = [
  { src: "/assets/associations/lace/gallery-1.jpg", alt: "LACE Gallery 1" },
  { src: "/assets/associations/lace/gallery-2.jpg", alt: "LACE Gallery 2" },
  { src: "/assets/associations/lace/gallery-3.jpg", alt: "LACE Gallery 3" },
];
