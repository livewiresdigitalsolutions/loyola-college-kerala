...
const fallback: GalleryImage[] = [
  { id: -1, image_url: "/assets/associations/lace/gallery-1.jpg", alt_text: "LACE Gallery 1" },
  { id: -2, image_url: "/assets/associations/lace/gallery-2.jpg", alt_text: "LACE Gallery 2" },
  { id: -3, image_url: "/assets/associations/lace/gallery-3.jpg", alt_text: "LACE Gallery 3" },
];
...
export default function Gallery() {
  ...
  useEffect(() => {
    fetch("/api/students/loyola-academy-for-career-enhancement?type=gallery")
      .then(r => r.json())
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {galleryImages.map((image) => (
                ...
                >
                  <Image
                    src={image.image_url}
                    alt={image.alt_text || "LACE Gallery"}
                    fill
