    ...
    <section className="relative w-full h-[400px] md:h-[500px]">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Loyola Academy for Career Enhancement"
          fill
          ...
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm">
              ...
              <span className="text-[#F0B129] font-medium">
                Loyola Academy for Career Enhancement (LACE)
              </span>
            </nav>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              Loyola Academy for Career Enhancement
              <span className="text-[#F0B129]"> (LACE)</span>
            </h1>
          </div>
        </div>
      </div>
