...
const fallback: TeamMember[] = [
  { id: -1, name: "Dr. Sunil Kumar P", role: "STAFF COORDINATOR", image_url: "/assets/associations/litcof/sunil-kumar.jpg", display_order: 0, is_active: true },
  { id: -2, name: "Ms. Sreelekshmi S", role: "STUDENT CO-ORDINATOR", image_url: "/assets/associations/litcof/neena-c-itty.jpg", display_order: 1, is_active: true },
  { id: -3, name: "Ms. Kshama Singh K P", role: "STUDENT CO-ORDINATOR", image_url: "/assets/associations/litcof/gayathri-as.jpg", display_order: 2, is_active: true },
];
...
export default function OrganizingTeam() {
  ...
  useEffect(() => {
    fetch("/api/students/loyola-academy-for-career-enhancement?type=organizing-team")
      .then(r => r.json())
