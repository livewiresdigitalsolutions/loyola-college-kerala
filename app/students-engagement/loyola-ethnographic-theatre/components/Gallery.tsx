...
const galleryImages = [
  { src: "/assets/associations/let/gallery-1.jpg", alt: "LET Gallery 1" },
  { src: "/assets/associations/let/gallery-2.jpg", alt: "LET Gallery 2" },
  { src: "/assets/associations/let/gallery-3.jpg", alt: "LET Gallery 3" },
];
