...
const galleryImages = [
  { src: "/assets/associations/womens-cell/gallery-1.jpg", alt: "Women Cell Gallery 1" },
  { src: "/assets/associations/womens-cell/gallery-2.jpg", alt: "Women Cell Gallery 2" },
  { src: "/assets/associations/womens-cell/gallery-3.jpg", alt: "Women Cell Gallery 3" },
];
