...
const galleryImages = [
  { src: "/assets/associations/nss/gallery-1.jpg", alt: "NSS Gallery 1" },
  { src: "/assets/associations/nss/gallery-2.jpg", alt: "NSS Gallery 2" },
  { src: "/assets/associations/nss/gallery-3.jpg", alt: "NSS Gallery 3" },
];
