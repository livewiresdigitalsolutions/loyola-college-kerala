...
const teamMembers = [
  {
    ...
    image: "/assets/team/andrew-michael.jpg",
  },
  {
    name: "Dr. Sonny Jose",
    role: "MENTORING COORDINATOR",
    image: "/assets/team/sonny-jose.jpg",
  },
  {
    name: "Dr. Pramod S K",
    role: "MENTORING COORDINATOR",
    image: "/assets/team/pramod-sk.jpg",
  },
];
      ...
      <div className="flex flex-wrap justify-center gap-12 md:gap-24">
        {teamMembers.map((member, i) => (
          <div key={i} className="flex flex-col items-center text-center">
            {/* Circular Image */}
            <div className="w-[140px] h-[140px] md:w-[160px] md:h-[160px] rounded-full overflow-hidden shadow-md shadow-gray-200 mb-6 drop-shadow-sm">
              <Image
                src={member.image}
                alt={member.name}
                width={160}
