...
const galleryImages = [
  { src: "/assets/associations/litcof/gallery-1.jpg", alt: "LITCOF Gallery 1" },
  { src: "/assets/associations/litcof/gallery-2.jpg", alt: "LITCOF Gallery 2" },
  { src: "/assets/associations/litcof/gallery-3.jpg", alt: "LITCOF Gallery 3" },
];
