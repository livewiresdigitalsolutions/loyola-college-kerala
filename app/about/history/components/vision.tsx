        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-block mb-6">
              <span className="text-primary/60 text-sm font-medium tracking-wider uppercase">
                THE BEGINNING
              </span>
            </div>
          ...
          <div className="relative">
            <div className="relative aspect-[3/3] w-full overflow-hidden rounded-lg shadow-2xl">
              <Image
