          ...
          <div className="max-w-7xl mx-auto px-6 w-full">
            <div className="max-w-3xl">
              ...
              <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-[#F0B129] font-medium">History</span>
              </nav>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                History of Loyola College<br />of Social Sciences
              </h1>

              {/* Subtext */}
              <p className="mt-6 text-xl md:text-lg text-white/90 leading-relaxed max-w-2xl">
                Tracing over six decades of excellence in education, social transformation, 
                and the Jesuit tradition of forming men and women for others.
              </p>
            </div>
          </div>
        </div>
