          ...
          <div className="max-w-7xl mx-auto px-6 w-full">
            <div className="max-w-3xl">
              ...
              <nav className="flex items-center gap-2 text-white/90 mb-8 text-sm">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-[#F0B129] font-medium">Institutional Governance</span>
              </nav>
              ...
              <p className="mt-6 text-xl md:text-lg text-white/90 leading-relaxed max-w-2xl">
                A transparent and accountable governance structure ensuring academic excellence 
                and institutional integrity through dedicated leadership.
              </p>
            </div>
          </div>
        </div>
