...
function HallTicketPreviewContent() {
  ...
  useEffect(() => {
    if (autoDownload && hallTicketData && programDetails && !isDownloading) {
      setTimeout(() => {
        handleDownloadPDF(true); // Pass true to indicate auto-close
      }, 1500); // Wait 1.5s for render
    }
  }, [autoDownload, hallTicketData, programDetails]);
  ...
  const handleDownloadPDF = async (shouldAutoClose = false) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex gap-5 mt-4">
              ...
              <div className="flex-1">
                <table className="w-full border-collapse">
                  <tbody>
                    <tr>
                      <td className="border border-primary p-1.5 px-2.5 w-2/5 font-bold text-[11pt] bg-gray-50">
                        Application ID
                      </td>
                    ...
                    <tr>
                      <td className="border border-primary p-1.5 px-2.5 font-bold text-[11pt] bg-gray-50">
                        Name
                      </td>
                      <td className="border border-primary p-1.5 px-2.5 text-[11pt]">
                ...
                {/* Exam Details */}
                <div className="mt-4 border-2 border-primary p-2.5 bg-gray-50">
                  <h3 className="text-primary text-sm font-bold mb-2 uppercase">
                    Exam Details
                  </h3>
            ...
            <div className="mt-6 border-t-2 border-primary pt-4">
              <h3 className="text-primary text-sm font-bold mb-3 uppercase">
